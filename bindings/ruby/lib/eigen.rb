...
module Eigen
    ...
    class Vector2
        ...
        def self.Unset
            return Vector2.new(Base.unset, Base.unset, Base.unset)
        end
        ...
        # Returns the (1, 0) unit vector
        def self.UnitX()
            return Vector2.new(1, 0)
        end

        # Returns the (0, 1) unit vector
        def self.UnitY()
        ...
        # Tests for equality
        #
        # Since Vector2 stores the coordinates as floating-point values, this is
        # a bad test. Use
        #
