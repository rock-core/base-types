...
IF(RUBY_EXECUTABLE AND NOT  RUBY_VERSION_MAJOR)
   ...
   EXECUTE_PROCESS(COMMAND
       ${RUBY_EXECUTABLE} -r rbconfig -e "print Config::CONFIG.values_at('MAJOR','MINOR','TEENY','archdir','arch','rubyhdrdir','libdir','rubylibdir','LIBRUBY_SO').join(';')"
       OUTPUT_VARIABLE RUBY_INFO)

   list(GET RUBY_INFO 0 RUBY_VERSION_MAJOR)
   list(GET RUBY_INFO 1 RUBY_VERSION_MINOR)
   list(GET RUBY_INFO 2 RUBY_VERSION_PATCH)
   list(GET RUBY_INFO 3 RUBY_ARCH_DIR)
   list(GET RUBY_INFO 4 RUBY_ARCH)
   list(GET RUBY_INFO 5 RUBY_HDR_DIR)
   list(GET RUBY_INFO 6 RUBY_POSSIBLE_LIB_DIR)
   list(GET RUBY_INFO 7 RUBY_RUBY_LIB_DIR)
   list(GET RUBY_INFO 7 RUBY_RUBY_LIBRARY)
