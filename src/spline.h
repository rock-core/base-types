...
namespace geometry {
    ...
    public:
         ...
         * curve_parameter)
         */
        Eigen::Vector3d poseError(Eigen::Vector3d _position, double _heading, double _guess_param, double _tolerance)
        { return SplineBase::poseError(_position, _heading, _guess_param, _tolerance); }
    };
