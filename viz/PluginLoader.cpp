...
vizkit3d::QtPluginVizkitBase::QtPluginVizkitBase() {
}

QStringList* vizkit3d::QtPluginVizkitBase::getAvailablePlugins() const {
...
QObject* vizkit3d::QtPluginVizkitBase::createPlugin(QString const& pluginName) {
