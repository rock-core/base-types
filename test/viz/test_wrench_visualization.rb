    ...
    describe 'WrenchVisualization' do
        ...
        describe "updateData(Wrench)" do
            ...
            it "updates wrench" do
                ...
                @viz.updateData(wrench)
                confirm 'Force should be displayed as a red arrow from (0,0,0) to (1,0,0) and torque as a green arrow from (0,0,0) to (1,0,0) with a circular arrow rotating counter-clockwise around axis'
            end
            ...
            it "updates wrench" do
                ...
                @viz.updateData(wrench)
                confirm 'Force should be displayed as a red arrow from (0,0,0) to (0,1,0) and torque as a green arrow from (0,0,0) to (0,1,0) with a circular arrow rotating counter-clockwise around axis'
            end
            ...
            it "updates wrench" do
                ...
                @viz.updateData(wrench)
                confirm 'Force should be displayed as a red arrow from (0,0,0) to (0,0,1) and torque as a green arrow from (0,0,0) to (0,0,1) with a circular arrow rotating counter-clockwise around axis'
            end
        ...
        describe "setSeperateAxesTorque" do
            it "displays torque axis component" do
                torque = Type.base.Vector3d.new(1,1,1)
        ...
        describe "setSeperateAxesForce" do
            it "displays force axis component" do
                force = Type.base.Vector3d.new(1,1,1)
                @viz.setForce(force)
